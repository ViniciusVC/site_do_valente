      ...
      <>
          <div className="segundaviaDivlinha">
              <div>
                  ...
                  <BtLink href="https://www.oi.com.br/codigo/codigo-de-barras/" value="Acessar conta" estilo="laraja-degrade"/>
                  <p className="segundaViaP" >
                    <span>Pra acessar sua conta detalhada e os serviços Oi TV e Fibra, </span>
                  </p>
                  <Link href="https://login.oi.com.br/nidp/app/login?id=loginsegurancasso&sid=10&option=credential&sid=10" value="entre na Minha Oi" estilo="Link2"/>
              </div>
              ...
              <div>
                  <div className="imagem">
                    <Img
                            src="/static/assetsv5/img/minhaOi/segunda-via/notebook.png"
                            width="352px"
                            height="330px"
