       ...
       <>
            <div className="segundaviaDivlinha3">
                ...
                <div className="session3ladoDireito">
                        ...
                        <div>
                            <Img
                                src="/static/assetsv5/img/minhaOi/segunda-via/seguranca@2x.png"
                                width="30px"
                                height="32.2px"
                        ...
                        <div>
                            <Img
                                src="/static/assetsv5/img/minhaOi/segunda-via/codBar@2x.png"
                                width="30px"
                                height="32.2px"
                                alt="Compdonente Img exemplo next"
                                title="Componente Img exemplo next"
                        ...
                        <div>
                            <Img
                                src="/static/assetsv5/img/minhaOi/segunda-via/mask@2x.png"
                                width="30px"
                                height="32.2px"
                                alt="Compdonente Img exemplo next"
                                title="Componente Img exemplo next"
                        ...
                        <div>
                            <Img
                                    src="/static/assetsv5/img/minhaOi/segunda-via/star@2x.png"
                                    width="30px"
                                    height="32.2px"
                                    alt="Compdonente Img exemplo next"
                                    title="Componente Img exemplo next"
