      ...
      <>
         <div className="segundaviaDivlinha2">
                <div className="imagem2">
                    <Img
                            src="/static/assetsv5/img/minhaOi/segunda-via/ilustraPeople.png"
                            width="300px"
                            height="280px"
                ...
                <div className="divLadoDireito">
                   ...
                   <div>
                        <span className="tituloSpam">
                             Receba a sua conta 
                        </span>
                   </div>
                   <b className=" tituloSpam">por e-mail todo mês</b>
                    ...
                    <div className='button'>
                        <BtLink href="https://www.oi.com.br" value="Eu quero" estilo="rosa-invetido"/>
                    </div>
                </div>
                <div className="imagem1">
                    <Img
                            src="/static/assetsv5/img/minhaOi/segunda-via/clip2.svg"
                            width="152px"
                            height="186px"
                            alt="Compdonente Img exemplo next"
                            title="Componente Img exemplo next"
