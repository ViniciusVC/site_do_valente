                ...
                <div className="segundaviaDivlinha4">
                        <div className="ladoEsquerdo">
                            ...
                            <div className ="sessionButton">
                              <BtLink href="https://www.oi.com.br/codigo/codigo-de-barras/" value="Ativar agora" estilo="laraja-degrade"/>
                            </div>
                        </div>
                        <div className="imagem">
                            <Img
                                src="/static/assetsv5/img/minhaOi/segunda-via/ilustraCellphone.png"
                                width="324px"
                                height="290px"
