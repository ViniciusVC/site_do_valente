    ...
    return (
      <div>
        ...
        <div>
          ...
          <a className="btEntrar btEntrar-mobile" href="https://m.oi.com.br/Portal/splash">
            ENTRAR
            </a>
        </div>
        <style jsx>{`
            ...
            .btEntrar {
              padding: 16px 40px ;
              transition: all 0.8s;
              font-family: Simplon-Headline, oiTextRegular, sans-serif;
