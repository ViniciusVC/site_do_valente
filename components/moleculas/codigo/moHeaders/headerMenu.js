        ...
        <section className="fZMEGE">
            <div>
                <nav className="jmPZmE">
                    <div className="ixAXz">
                        <a className="btn-menu sem-submenu iaXBsB" href="https://www.oi.com.br/codigo/">
                            INÍCIO
                        </a>
                    </div>
                    <div className="cMkdVA">
                        <a className="btn-menu sem-submenu iaXBsB" href="https://minha.oi.com.br/codigo-de-barras/">
                            CONTAS E PAGAMENTOS
                        </a>
                    </div>
                    ...
                    <div className="bhQqYh">
                        <a className="btn-menu sem-submenu iaXBsB" href="https://www.oi.com.br/recarga/">  
                            RECARGA
                        </a>
                    </div>
                    ...
                    <div className="submenu ">
                            <div className="Row sc-hMqMXs keDYPe">
                                ...
                                <div className="col imJzZn">
                                    ...
                                    <div>
                                        <a className="button-menu iaXBsB"
                                        href="https://www.oi.com.br/oi/oi-pra-voce/atendimento/fale-com-a-oi/lojas-fisicas-da-oi/"
                                           >
                                            Encontre sua loja
                                        </a>
                                    </div>
                                    <div>
                                        ...
                                        href="https://www.oi.com.br/codigo/fale-com-a-oi/"
                                           >
                                            Telefones e postos
                                        </a>
                                    </div>
                                ...
                                <div className="col imJzZn">
                                    ...
                                    <div>
                                        <a className="button-menu iaXBsB"
                                        href="https://www.oi.com.br/app/tecnico-virtual/"
                                           >
                                            Técnico Virtual
                                        </a>
                                    </div>
                                    <div>
                                        <a className="button-menu iaXBsB"
                                        href="https://www.oi.com.br/oi/oi-pra-voce/planos-servicos/oi-fixo/servicos/acompanhamento-do-oi-fixo/"
                                           >
                                    ...
                                    <div>
                                        <a className="button-menu iaXBsB"
                                        href="https://minha.oi.com.br/religar-servico/"
                                           >Estou sem serviço
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div className="col imJzZn">
                        <div>
                            <a className="button-menu iaXBsB" href="https://www.oi.com.br/oi/oi-pra-voce/planos-servicos/oi-pontos/">
                                Oi Pontos
                            </a>
                        </div>
                        <div>
                        ...
                        <div>
                            <a className="button-menu   iaXBsB" href="https://www.oiplay.tv/">
                                Oi Play
                            </a>
                        </div>
                    </div>
