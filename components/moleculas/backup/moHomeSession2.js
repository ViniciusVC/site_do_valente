...
const moHomeSession2 = props => {
    ...
    return (
        <div className="moHomeSession2">
            <div>
                <Img
                        src="https://www.oi.com.br/codigo/assets/images/notebook-internet.jpg"
                        width="600px"
                        height="400px"
            ...
            <div>
                ...
                <BtLink href="http://oi.com.br/lp/clientebl-aumente-bandalarga?origem=minhaoi30_prelogin&pagina=clientebl-aumente-bandalarga" value="Veja a disponibilidade" estilo="amarelo1"/>
