      ...
      <div>
        <div>
          <nav>
            <ul>
              <li className="active">
                <a href="/oi/oi-pra-voce" title="Oi Pra Você">Oi Pra Você</a>
              </li>
              <li className="">
                <a href="/oi/oi-pra-empresas" title="Oi pra Empresas">Oi pra Empresas</a>
              </li>
              <li className="">
                <a href="/oi/sobre-a-oi" title="Sobre a Oi">Sobre a Oi</a>
              </li>
              <li className="">
                <a href="http://ri.oi.com.br" title="Investidores | Investors">Investidores | Investors</a>
              </li>
            </ul>
          </nav>
        </div>
