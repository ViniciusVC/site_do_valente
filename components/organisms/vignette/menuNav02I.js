...
const menuNav02I = props => {
  ...
  return(
      <nav>
        ...
        <ul>
          <li>
            <a  href="/oi/oi-pra-voce/planos-servicos/oi-fixo/planos/conheca-os-planos#simuladorBox" title="Fixo">Fixo</a>	   
          </li>
          <li>
            <a  href="/oi/oi-pra-voce/31/simulador" title="Longa  Distância">Longa  Distância</a>	   
          </li>
        </ul>
    <style jsx>{`
    .a{
