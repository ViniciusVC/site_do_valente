...
const menuNav02F = props => {
  ...
  return(
      <nav>
        ...
        <ul>
          <li>
            <a href="/oi/oi-pra-voce/planos-servicos/oi-fixo/planos/conheca-os-planos" title="Conheça os Planos">Conheça os Planos</a>
          </li>
          <li>
            <a href="/oi/oi-pra-voce/planos-servicos/oi-fixo/servicos/servicos-pro-seu-oi-fixo" title="Serviços pro seu Oi Fixo">Serviços pro seu Oi Fixo</a>
          </li>
          <li>
            <a href="/oi/oi-pra-voce/planos-servicos/oi-fixo/servicos/orelhao" title="Orelhão">Orelhão</a>
          </li>
          <li>
