  ...
  render() {
    ...
    return (
      <section class="slick-slide slick-cloned internet" data-index="1" tabIndex="-1" data-reactid="179">
        {/*<section style="outline:none;background-image:url(https://www.oi.com.br/publicV2/heros/internet/hero-fibra-320.jpg);background-size:cover;" class="slick-slide slick-cloned internet" data-index="1" tabindex="-1" data-reactid="179">*/}
