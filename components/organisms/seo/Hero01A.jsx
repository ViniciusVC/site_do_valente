  ...
  render() {
    ...
    return (
      <section class="slick-slide slick-cloned" data-index="-1">
        {/*<section style="background-image:url(https://www.oi.com.br/publicV2/carousel/pre/virada-maes-2019-pre-pago-320px.jpg);background-size:cover;" class="slick-slide slick-cloned" data-index="-1">*/}
        ...
        <div class="sliderr slide-wrapper">
          <div class="container">
            <div class="slide type6">
              ...
              <a class="banner button-cta" data-context="" href="https://www.oi.com.br/celular/pre-pago">Conheça a oferta</a>
            </div>
          </div>
        </div>
      </section>
