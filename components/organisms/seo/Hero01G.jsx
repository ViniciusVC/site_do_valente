  ...
  render() {
    ...
    return (
      <section class="slick-slide slick-cloned" data-index="5">
        {/*<section style="background-image:url(https://www.oi.com.br/publicV2/carousel/controle/bg-banner-home-controle-320.jpg);background-size:cover;" class="slick-slide slick-cloned" data-index="5"> */}
        ...
        <div class="sliderr slide-wrapper">
          <div class="container">
            <div class="slide type7">
              ...
              <img class="hero-mob-offerimage" src="https://www.oi.com.br/publicV2/12gb-apps-liberados-desk.svg" alt="12 GB + Messenger e Whatsapp" />
              <div class="hero-offer-social">
                <span class="hero-gb-offer"></span>
                <img class="hero-social-network" src="http://www.oi.com.br/publicV2/12gb-apps-liberados-desk.svg" alt="12 GB + WhatsApp, Facebook, Instagram e Messenger" />
              </div>
              <div class="obs">
