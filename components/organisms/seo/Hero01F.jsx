  ...
  render() {
    ...
    return (
      <section class="slick-slide slick-cloned" data-index="4" tabIndex="-1" data-reactid="238">
        {/*<section style="outline:none;background-image:url(https://www.oi.com.br/publicV2/carousel/pre/virada-maes-2019-pre-pago-320px.jpg);background-size:cover;" class="slick-slide slick-cloned" data-index="4" tabindex="-1" data-reactid="238">*/}
              ...
              <div class="medium-up" data-reactid="253">
                <div class="description" data-reactid="254">
                  <div class="car-home-subtitle" data-reactid="255">
                    ...
                    <p>internet na Minha Oi.</p>
                  </div>
                </div>
              </div>
              <a class="banner button-cta" data-context="" href="https://www.oi.com.br/celular/pre-pago" data-reactid="256">Conheça a oferta</a>
            </div>
          </div>
        </div>
