  ...
  return (
    <div>
      ...
      <Div display="justificado">
        <div className="codigoApacheListadeRotas">
          <ListadeRotas/>
        </div>
        <div className="codigoApache">
        <h1>REDIRECT</h1>
          <p>
          <br/>Outra diretiva bem interessante é a Redirect.
          <br/>Oque ela faz?
          ...
          <br/>
          <br/>Ao requisitar http://linuxextreme.exemplos.com.br , haverá um redirecionamento para http://www.google.com.br
          <br/>
          <br/>Posso fazer com que esse redirecionamento se torne permanente para o cliente
          <br/>
          <br/>Redirect permanent   /melhorblog   https://linuxextreme.wordpress.com
          <br/>Redirect /musicas   http://www.srv.com/musicas
          <br/>Redirect  /  https://linuxextreme.exemplos.com.br/
          <br/>
