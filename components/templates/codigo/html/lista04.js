...
const atendimentoOi = function (props) {
  ...
  console.log('╔════════════════════════════════════╗');
  console.log('║ Template - codigo - HTML - Lista04 ║');
  console.log('╚════════════════════════════════════╝');
  ...
  return (
    <div>
      <MoHead modo={modo} title="HTML Lista Ordenada type i" description="HTML Lista Ordenada type i" canonical="/codigo/html/lista04/"/>
