...
const atendimentoOi = function (props) {
  ...
  return (
    <div>
      <Head>
        <title>HTML Formulario</title>
        <FaviIcon />
        <meta name="description" content="HTML Formulario" />
        <link rel="canonical" href="/codigo/html/formulario/" />
        <link rel="amphtml" href="/amp/codigo/html/formulario/" />
