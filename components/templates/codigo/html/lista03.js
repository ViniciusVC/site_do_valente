...
const atendimentoOi = function (props) {
  ...
  console.log('╔════════════════════════════════════╗');
  console.log('║ Template - codigo - HTML - Lista03 ║');
  console.log('╚════════════════════════════════════╝');
  ...
  return (
    <div>
      <MoHead modo={modo} title="HTML Lista Ordenada type A" description="HTML Lista Ordenada type A" canonical="/codigo/html/lista03/"/>
