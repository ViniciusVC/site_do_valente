  ...
  return (
    <div>
      ...
      <Layout regiao={regiao} modo={modo} titulo="Utilitarios" categoria="Utilitarios">
          ...
          <BtLink href={"/utilitarios/conversordetexto?regiao="+regiao} value="Conversor de Texto" estilo="neon"/><br/>
          Conversão de textos maiusculos e minusculos.<br/>
          Experimento de codigo em javascript.<br/><br/>
          <BtLink href={"/utilitarios/conversordeunidade?regiao="+regiao} value="conversor de Unidade" estilo="neon"/><br/>
          Conversão de medidas de comprimento.<br/>
          Outro experimento de codigo em javascript.<br/><br/>
          <BtLink href={"/utilitarios/servicosgratuitos?regiao="+regiao} value="Servicos Gratuitos" estilo="neon"/><br/>
