...
const conversordetexto = function (props) {
  ...
  return (
    <div>
      <Head>
        <title>Serviços Gratuitos</title>
        <FaviIcon />
        <meta name="description" content="Serviços Gratuitos" />
        <link rel="canonical" href="/game/servicosgratuitos/" />
        <link rel="amphtml" href="/amp/game/servicosgratuitos/" />
