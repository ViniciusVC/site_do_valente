...
var conversordetexto = function conversordetexto(props) {
  ...
  if (modo == "html" || modo == "HTML") {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      ...
      rows: "6",
      cols: "40",
      className: "jsx-332482176" + " " + "DesenhoSombra"
      ...
      className: "jsx-332482176" + " " + "btLinkNeon"
      ...
      id: "332482176"
    }, [".textarea.jsx-332482176{width:100%;}", ".btLinkBranco.jsx-332482176{height:3.42857143rem;}", ".btLinkNeon.jsx-332482176{border:solid 2px #00ffea;border-radius:5px;padding:5px;-webkit-transition:all 0.8s;transition:all 0.8s;font-family:oiTextRegular,sans-serif;background-color:#00ffea;background:rgba(0,255,255,0.2);color:#00ffea;display:block;font-size:1rem;text-align:center;-webkit-text-decoration:none;text-decoration:none;cursor:pointer;outline:0;margin-right:5px;margin-bottom:5px;box-sizing:border-box;font-style:normal;width:100%;max-width:500px;}", ".btLinkNeon.jsx-332482176:hover{-webkit-transition:all 0.8s;transition:all 0.8s;-webkit-transition:all 0.8s;-moz-transition:all 0.8s;-o-transition:all 0.8s;background-color:#4a516b;}", ".DesenhoSombra.jsx-332482176{font-family:oiTextRegular,sans-serif;background-color:#ffffff;border-radius:8px;color:#222222;display:block;font-size:1rem;text-align:center;width:90%;-webkit-text-decoration:none;text-decoration:none;border:solid 1px #dbdbdb;cursor:pointer;outline:0;margin:10px;padding:1.2rem;box-sizing:border-box;font-style:normal;-webkit-transition:0.5s;transition:0.5s;-webkit-box-shadow:1px 1px 10px rgba(1,1,1,0.47);-moz-box-shadow:1px 1px 10px rgba(1,1,1,0.47);box-shadow:1px 1px 10px rgba(1,1,1,0.47);}", ".btLinkBranco.jsx-332482176:hover{-webkit-box-shadow:2px 2px 20px rgba(1,1,1,0.17);-moz-box-shadow:2px 2px 20px rgba(1,1,1,0.17);box-shadow:2px 2px 20px rgba(1,1,1,0.17);}"]));
  } else {
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_moleculas_moHead__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], {
      ...
      display: "vertical"
    }, "O utilitario para converter texto n\xE3o funciona no modo AMP.", react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("br", null), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_atoms_atBtLink__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"], {
      href: "/utilitarios/conversordetexto/",
      value: "Sair do modo AMP.",
      estilo: "neon"
    }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("br", null)), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_atoms_atDiv__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"], {
      display: "vertical"
    }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("br", null), "Converter para TUDO MAIUSCULA.", react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("br", null), "Converter para tudo minuscula.", react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("br", null), "Converter para Primeira letra da fraze maiuscula.", react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("br", null), "Converter para pRIMEIRA lETRA dA fRAZE mINUSCULA.", react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("br", null), "Converter para Todas As Primeiras Letras Maiusculas.", react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("br", null), "Converter para tODAS aS pRIMEIRAS lETRAS mINUSCULAS.", react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("br", null)))));
  }
};
