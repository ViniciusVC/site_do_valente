...
module.exports = __webpack_require__("ZGdw");
...
/* harmony import */ var _controller_util_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("JkDD");
/* harmony import */ var _components_templates_game_cobrinha_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("pJbi");
...
var RotaCobrinha = function RotaCobrinha(props) {
  var regiao = _controller_util_js__WEBPACK_IMPORTED_MODULE_2__[/* validaProps */ "h"](props.url.query.regiao, "RJ");
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_templates_game_cobrinha_js__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], {
    modo: "amp",
    regiao: regiao
  });
...
/* harmony default export */ __webpack_exports__["default"] = (Object(next_amp__WEBPACK_IMPORTED_MODULE_1__["withAmp"])(RotaCobrinha)); // Usado para páginas AMP
...
// CONCATENATED MODULE: ./components/organisms/orgCobrinha/index.js




var orgCobrinha_orgCobrinha = function orgCobrinha(props) {
  ...
  function game() {
    ...
    ctx.fillStyle = "red";
    ctx.fillRect(ax * tp, ay * tp, tp, tp); //var objImgMaca = document.getElementById("imgmaca");
  ...
  return external_react_default.a.createElement(atDiv["a" /* default */], {
    ...
    className: "jsx-586914315"
  }, external_react_default.a.createElement("a", {
    id: "btLinkIniciar",
    onClick: function onClick() {
      iniciarGame();
    },
    className: "jsx-586914315" + " " + "btCinza"
  }, "Iniciar Game Cobrinha"), external_react_default.a.createElement("canvas", {
    id: "stage",
    width: "600",
    height: "600",
    className: "jsx-586914315"
    ...
    id: "imgmaca",
    src: "https://superprix.vteximg.com.br/arquivos/ids/175207-292-292/Maca-Argentina--1-unidade-aprox.-200g-.png?v=636294203590200000",
    className: "jsx-586914315" + " " + "imgmaca"
  })), external_react_default.a.createElement("div", {
    id: "Controles",
    className: "jsx-586914315" + " " + "Controles"
  }), external_react_default.a.createElement(style_default.a, {
    id: "586914315"
  }, [".imgmaca.jsx-586914315{display:none;}", "canvas.jsx-586914315{border :solid 1px;}", ".btCinza.jsx-586914315{padding:10px;-webkit-transition:all 0.8s;transition:all 0.8s;font-family:oiTextRegular,sans-serif;background-color:#26293c;border-radius:15px;color:#ffffff;display:block;font-size:1rem;text-align:center;-webkit-text-decoration:none;text-decoration:none;border:solid 2px #4a516b;cursor:pointer;outline:0;margin-bottom :10px;box-sizing:border-box;font-style:normal;width:100%;max-width:600px;}", ".btCinza.jsx-586914315:hover{-webkit-transition:all 0.8s;transition:all 0.8s;-webkit-transition:all 0.8s;-moz-transition:all 0.8s;-o-transition:all 0.8s;background-color:#4a516b;}"]));
};

/* harmony default export */ var organisms_orgCobrinha = (orgCobrinha_orgCobrinha);
// EXTERNAL MODULE: ./controller/util.js
var util = __webpack_require__("JkDD");
...
// CONCATENATED MODULE: ./components/templates/game/cobrinha.js
...
function retornaogame(modo, regiao) {
  if (modo == "html") {
    return external_react_default.a.createElement(organisms_orgCobrinha, null);
  } else {
...
var cobrinha_TemplateCobrinha = function TemplateCobrinha(props) {
  console.log('╔══════════════════════════════════╗');
  ...
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement(moHead["a" /* default */], {
    ...
    titulo: "Games",
    categoria: "Games"
  }, external_react_default.a.createElement("h1", null, "Game Cobrinha"), retornaogame(modo, regiao), external_react_default.a.createElement("br", null)));
...
/* harmony default export */ var cobrinha = __webpack_exports__["a"] = (cobrinha_TemplateCobrinha);
