...
// CONCATENATED MODULE: ./components/organisms/orgEcossistema/index.js




var orgEcossistema_orgEcossistema = function orgEcossistema(props) {
  var relogio;
  var personagens = [];
  ...
  function comportamento() {
    ...
    for (serA = 2; serA < personagens.length; serA++) {
      ...
      if (personagens[serA].tipo == "carnivoro" || personagens[serA].tipo == "herbivoro") {
        ...
        funcPropSer("altera", serA, "herbivoro", "manter", "manter"); // }else if(personagens[serA].tipo=="planta"&&personagens[serA].tempo<1){
  ...
  return external_react_default.a.createElement(atDiv["a" /* default */], {
    display: "responsivo"
  }, external_react_default.a.createElement("div", {
    className: "jsx-3065395871"
  }, external_react_default.a.createElement("a", {
    id: "btLinkIniciar",
    onClick: function onClick() {
      iniciarGame();
    },
    className: "jsx-3065395871" + " " + "btCinza"
  }, "Iniciar Ecossistema"), external_react_default.a.createElement("canvas", {
    id: "canvasGame",
    width: "600",
    height: "600",
    className: "jsx-3065395871"
    ...
    id: "Controles",
    className: "jsx-3065395871" + " " + "Controles"
  }, external_react_default.a.createElement(atDiv["a" /* default */], {
    display: "vertical"
  }, external_react_default.a.createElement("h2", {
    className: "jsx-3065395871"
  }, "Controle do personagem AVATAR."), external_react_default.a.createElement("a", {
    id: "btLinkIniciar",
    onClick: function onClick() {
      moverPersonagem(1, "subir");
    },
    className: "jsx-3065395871" + " " + "btCinza"
  }, "sobe"), external_react_default.a.createElement(atDiv["a" /* default */], {
    display: "justificado"
  }, external_react_default.a.createElement("a", {
    id: "btLinkIniciar",
    onClick: function onClick() {
    ...
    className: "jsx-3065395871" + " " + "btCinza"
  }, "esquerda"), external_react_default.a.createElement("a", {
    id: "btLinkIniciar",
    onClick: function onClick() {
      moverPersonagem(1, "->");
    },
    className: "jsx-3065395871" + " " + "btCinza"
  }, "direita")), external_react_default.a.createElement("a", {
    id: "btLinkIniciar",
    onClick: function onClick() {
      moverPersonagem(1, "descer");
    },
    className: "jsx-3065395871" + " " + "btCinza"
  }, "desce"))), external_react_default.a.createElement(style_default.a, {
    id: "3065395871"
  }, [".Controles.jsx-3065395871{margin:10px;width:100%;display:none;}", ".Godzilla.jsx-3065395871{position:absolute;}", "canvas.jsx-3065395871{display:none;}", ".btCinza.jsx-3065395871{padding:10px;-webkit-transition:all 0.8s;transition:all 0.8s;font-family:oiTextRegular,sans-serif;background-color:#26293c;border-radius:15px;color:#ffffff;display:block;font-size:1rem;text-align:center;-webkit-text-decoration:none;text-decoration:none;border:solid 2px #4a516b;cursor:pointer;outline:0;margin-bottom :10px;box-sizing:border-box;font-style:normal;width:100%;max-width:600px;}", ".btCinza.jsx-3065395871:hover{-webkit-transition:all 0.8s;transition:all 0.8s;-webkit-transition:all 0.8s;-moz-transition:all 0.8s;-o-transition:all 0.8s;background-color:#4a516b;}"]));
...
/* harmony default export */ var organisms_orgEcossistema = (orgEcossistema_orgEcossistema);
...
// CONCATENATED MODULE: ./components/templates/game/ecossistema.js
...
function retornaogame(modo, regiao) {
  if (modo == "html") {
    return external_react_default.a.createElement(organisms_orgEcossistema, null);
  } else {
...
var ecossistema_ecossistema = function ecossistema(props) {
  console.log('╔══════════════════════════════════════╗');
  ...
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement(moHead["a" /* default */], {
    ...
    titulo: "Games",
    categoria: "Games"
  }, external_react_default.a.createElement("h1", null, "Simulador de Ecossistema"), retornaogame(modo, regiao), external_react_default.a.createElement("p", null, "Carnivoro come herbivoro.", external_react_default.a.createElement("br", null), "herbivoro come planta, foge de carnivoro e se reproduz."), external_react_default.a.createElement("p", null, "Estudo de desenvolvimento de game apenas com JS e canvas."), external_react_default.a.createElement("br", null)));
}; // <div className="Godzilla" id="position">
// <a href="#meuLink" onclick="myFunction();">
//<img onload="mouse();" alt="Fundo" src="https://img-s-msn-com.akamaized.net/tenant/amp/entityid/BBVShEa.img?h=416&amp;w=799&amp;m=6&amp;q=60&amp;u=t&amp;o=f&amp;l=f&amp;x=871&amp;y=654" width="100%" height="100%" title="Cenário de cidades"></img>


/* harmony default export */ var game_ecossistema = __webpack_exports__["a"] = (ecossistema_ecossistema);
...
module.exports = __webpack_require__("kn66");
...
/* harmony import */ var _controller_util_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("JkDD");
/* harmony import */ var _components_templates_game_ecossistema__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("+kBU");
...
var RotaEcossistema = function RotaEcossistema(props) {
  var regiao = _controller_util_js__WEBPACK_IMPORTED_MODULE_2__[/* validaProps */ "h"](props.url.query.regiao, "RJ");
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_templates_game_ecossistema__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], {
    modo: "amp",
    regiao: regiao
  });
...
/* harmony default export */ __webpack_exports__["default"] = (Object(next_amp__WEBPACK_IMPORTED_MODULE_1__["withAmp"])(RotaEcossistema)); // Usado para páginas AMP
