...
// CONCATENATED MODULE: ./components/templates/codigo/css/css07.js
...
var css07_atendimentoOi = function atendimentoOi(props) {
  console.log('╔════════════════════════════════════════╗');
  ...
  return external_react_default.a.createElement("div", {
    className: "jsx-2845939027"
  }, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", {
    className: "jsx-2845939027"
  }, "CSS 07 - Posicionamento de elementos, bordas e z-index"), external_react_default.a.createElement(atFavIcon["a" /* default */], null), external_react_default.a.createElement("meta", {
    name: "description",
    content: "CSS",
    className: "jsx-2845939027"
    ...
    className: "jsx-2845939027"
  }, "CSS 7 - Posicionamento de elementos, bordas e z-index"), external_react_default.a.createElement("div", {
    id: "div1",
    className: "jsx-2845939027"
  }, ' #div1{ ', "position: absolute; top:200px; left: 200px; width: 300px; height: 180px; background-color: brown; border-radius: 4px; -moz-border-radius: 4px; -webkit-border-radius: 4px; box-shadow: 2px 2px 2px #000000; z-index: 2;", ' } '), external_react_default.a.createElement("div", {
    id: "div2",
    className: "jsx-2845939027"
  }, ' #div2{ ', "position: relative; width: 300px; height: 180px; background-color:green; border-radius: 4px; -moz-border-radius: 4px; -webkit-border-radius: 4px; box-shadow: 4px 4px 4px #000000; z-index: 1;", ' } ')), external_react_default.a.createElement(style_default.a, {
    id: "2845939027"
  }, ["*.jsx-2845939027{margin:0;padding:0;}", "#div1.jsx-2845939027{position:absolute;top:200px;left:200px;width:300px;height:180px;background-color:brown;border-radius:4px;-moz-border-radius:4px;-webkit-border-radius:4px;box-shadow:2px 2px 2px #000000;z-index:2;}", "#div2.jsx-2845939027{position:relative;width:300px;height:180px;background-color:green;border-radius:4px;-moz-border-radius:4px;-webkit-border-radius:4px;box-shadow:4px 4px 4px #000000;z-index:1;}"]));
};

/* harmony default export */ var css07 = (css07_atendimentoOi);
// CONCATENATED MODULE: ./pages/routes/codigo/css/css07.js


 //import { withAmp } from 'next/amp';

var css07_RotaCSS = function RotaCSS(props) {
  //var cidade = Util.validaProps(props.url.query.cidade,"Rio de Janeiro")
  return external_react_default.a.createElement(css07, {
    modo: "html",
...
/* harmony default export */ var css_css07 = __webpack_exports__["default"] = (css07_RotaCSS);
