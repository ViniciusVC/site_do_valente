...
var conversordetexto = function conversordetexto(props) {
  ...
  function FuncConverter(varOpt) {
    ...
    if (varOpt == "a") {
      ...
      textooriginal = textooriginal.replace(/(?:^|\@\.)\s\S/g, function (a) {
        return a.toUpperCase();
      });
      saida = textooriginal;
    } else if (varOpt == "b") {
...
//# sourceMappingURL=conversordetexto.js.3a503ebe7c0a2e031c97.hot-update.js.map